import { input, output } from './dijkstra'
...
describe('Should transform correctly', () => {
    ...
    const transformedData = [
        ...
        [
            ...
            { value: 1, distance: 99999, parent: null, hasVisited: false, x: 1, y: 2 },
        ],
        [
            { value: 4, distance: 99999, parent: null, hasVisited: false, x: 2, y: 0 },
            { value: 0, distance: 99999, parent: null, hasVisited: false, x: 2, y: 1 },
            { value: 3, distance: 0, parent: null, hasVisited: false, x: 2, y: 2 },
        ]
    ]
    
    it('Should transform correctly', () => {
        expect(input(data)).toEqual(transformedData)
    })
})